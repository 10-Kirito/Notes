...
// 我们通过该文件可以看出编译器的功能的强大和局限性，比如说如果编译器无法处理类模板中的常量的话，就会定义一个常量，然后我们通过判断该常量是否定义来
// 判断我们所需要的功能编译器是否提供，因为我们有的函数或者功能的实现都是离不开这些功能的，如果编译器无法处理的话，我们就会采取另外的措施
// 针对各家不同的编译器以及不同版本，给予常量设置
// What this file does.
